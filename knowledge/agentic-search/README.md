...
Background docs live in [`docs/`](./docs/): start with [`docs/1-rag-vs-agentic.md`](./docs/1-rag-vs-agentic.md), then use [`docs/python-patterns.md`](./docs/python-patterns.md) as a Python reference while reading the code.
